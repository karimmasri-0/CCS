...
$category = ['id' => 1, 'name' => 'Power Tools', 'link' => 'power-tools', 'image' => '../../images/categories/Power-Tools.png'];
?>
<div>
    ...
    <div class="table w-full mt-8 bg-white rounded">
        <form action="" method="PUT" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
            <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:w-2/3">
                    <img class="w-20 h-20 sm:w-32 sm:h-32 rounded" src="<?= $category['image'] ?>" alt="avatar">
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
