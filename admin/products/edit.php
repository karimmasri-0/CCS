...
$product = ['id' => 1, 'stock' => 0, 'name' => 'Fiberglass Claw Hammer Pittsburgh 16 Oz. Shock', 'mrp' => 40, 'price' => 39.99, 'in_stock' => true, 'image' => '../../images/newest-collection/hammer.png'];
?>
<div>
    ...
    <div class="table w-full mt-8 bg-white rounded">
        <form action="" method="PUT" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3"></div>
                <div class="md:w-2/3">
                    <img class="w-20 h-20 sm:w-32 sm:h-32 rounded" src="<?= $product['image'] ?>" alt="avatar">
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
